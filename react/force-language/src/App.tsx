...
const COUNTRY_SELECT_NAME = 'country_forced_es'
...
function App() {
  ...
  return (
    <div>
      <h1>CountriesDB React Example - Force Language</h1>
      <p>This example forces the widget to display in Spanish.</p>
      ...
      <div className="form-group">
        <label htmlFor="subdivision-select">Provincia/Estado</label>
        <select

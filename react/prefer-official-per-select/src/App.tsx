...
const COUNTRY_SELECT_NAME = 'country_official'
...
function App() {
  ...
  return (
    <div>
      <h1>CountriesDB React Example - Prefer Official Per Select</h1>
      <p>This example demonstrates preferring official ISO subdivisions per select.</p>

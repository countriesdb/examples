...
const COUNTRY_SELECT_NAME = 'country_parent'
...
function App() {
  ...
  return (
    <div>
      <h1>CountriesDB React Example - Allow Parent Selection</h1>
      <p>This example enables selection of parent subdivisions in multi-level administrative hierarchies.</p>

...
const COUNTRY_SELECT_NAME = 'country_follow'
...
function App() {
  ...
  return (
    <div>
      <h1>CountriesDB React Example - Follow Related</h1>
      <p>This example demonstrates following related countries when selecting subdivisions.</p>

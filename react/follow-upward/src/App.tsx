...
const COUNTRY_SELECT_NAME = 'country_upward'
...
function App() {
  ...
  return (
    <div>
      <h1>CountriesDB React Example - Follow Upward</h1>
      <p>This example demonstrates following upward to parent countries when selecting subdivisions.</p>

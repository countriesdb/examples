# Basic Multi-select Example (CommonJS)

This example demonstrates how to use the CountriesDB widget with multi-select functionality using the standard HTML `multiple` attribute in a CommonJS environment.

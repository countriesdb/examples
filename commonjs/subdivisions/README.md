# CommonJS Subdivisions Example

This example demonstrates how to use `@countriesdb/widget` with CommonJS and browserify, including subdivisions (states/provinces).

# Prefer Official Subdivisions (Per-Select) - CommonJS

Demonstrates how to use `data-prefer-official` on a specific subdivision select to show official ISO subdivisions instead of extended translations, using CommonJS.

# Prefer Local Variant - CommonJS

Demonstrates how to display local variant names for official subdivisions when available using CommonJS.
...
- `window.CountriesDBConfig` includes `preferLocalVariant: true` to enable local variant preference

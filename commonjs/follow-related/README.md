# Follow Related Example (CommonJS)

This example demonstrates how to enable automatic navigation between related countries and territories using `followRelated` in the global configuration in a CommonJS environment.

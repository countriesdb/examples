# Default Language Example (CommonJS)

This example demonstrates how to set a default fallback language using `defaultLanguage` in the global configuration in a CommonJS environment.

# Follow Upward Example (ESM)

This example demonstrates how to enable automatic navigation up the subdivision hierarchy using `followUpward` in the global configuration in an ES Modules environment.

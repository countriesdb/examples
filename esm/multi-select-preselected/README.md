# Preselected Multi-select Example (ESM)

This example demonstrates how to use the CountriesDB widget with multi-select functionality and preselected values in an ES Modules environment.

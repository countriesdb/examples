# Multi-select :update Example (ESM)

This example demonstrates how to listen to `countriesWidget:update` events with multi-select selects in an ES Modules environment.
...
update-multiselect/
├── src/
│   └── widget.js          # Imports widget and wires up event listeners
├── public/

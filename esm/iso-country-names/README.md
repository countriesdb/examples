# ISO Country Names - ESM

Demonstrates how to display ISO short names for countries (e.g., "United States of America") instead of localized names using ES modules.

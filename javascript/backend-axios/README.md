## Backend Example – Node.js (axios)

Demonstrates calling the CountriesDB validation API from a Node service using [`axios`](https://github.com/axios/axios).
...
- `package.json` – declares the scripts plus `axios` dependency.
